"""
Django settings for verysecureauth project.
...
SECRET_KEY = 'django-insecure-aeg=1jiokvz*gf-%qy0l02%-0pa^@@*+t&j0j!-)5%so1z8ui4'
...
ROOT_URLCONF = 'verysecureauth.urls'
...
WSGI_APPLICATION = 'verysecureauth.wsgi.application'
